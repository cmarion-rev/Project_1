    ...
    public partial class Repository
    {
        public async Task<CustomerAccountTransactionsVM> GetAllTransactions(int customerID, int accountID)
        {
            ...
            try
            {
                ...
                {
                    List<AccountTransaction> tempTransactions = await myContext.AccountTransactions.Where(t => t.AccountID == accountID).OrderBy(t => t.TimeStamp).ToListAsync();
        ...
        public async Task<CustomerAccountTransactionsVM> GetAllTransactionsByDate(int customerID, int accountID, DateTime startDate, DateTime endDate)
        {
            CustomerAccountTransactionsVM result = new CustomerAccountTransactionsVM();
